 ...
 *               name:
 *                 type: string
 *                 example: Rafiul Faisal
 *               email:
 *                 type: string
 *                 example: rafiul.faisal@gmail.com
 *               password:
 *                 type: string
 *                 example: useAStrongPassword007
 *     responses:
 *       201:
 ...
 * /api/users/login:
 *   post:
 *     summary: Log in a user and return JWT tokens
 *     tags: [Users]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: Successfully logged in and received tokens
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 * /api/users/profile:
 *   put:
 *     summary: Update the authenticated user's profile (except email)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
